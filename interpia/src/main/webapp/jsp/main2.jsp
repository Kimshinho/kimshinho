				...
				<div id="content">
					...
					<div id="selectBox">
						<div>
							...
							</select> <input id="textfield1" name="textfield1" type="text"
								class="INPUT" value="${textfield1}">
								...
								<tr>
									<td height="35" colspan="7" align="center"
										...
										<div style="margin-left: 0px; margin-top: 20px;">
											<c:if test="${page >= 1 }">
												<a
													href="main_ok?page=${starpage}&select=${select}&textfield1=${textfield1}&thirdyear=${thiryear}&gender=${gender}&addr=${addr}"><img
											...
											<c:if test="${page>1 }">
												<a
													href="main_ok?page=${page-1 }&select=${select}&textfield1=${textfield1}&thirdyear=${thiryear}&gender=${gender}&addr=${addr}"><img
											...
											<c:forEach var="a" begin="${startpage }" end="${endpage }">
												...
												<c:if test="${a!=page }">
													<a
														href="main_ok?page=${a }&select=${select}&textfield1=${textfield1}&thirdyear=${thiryear}&gender=${gender}&addr=${addr}">${a}&nbsp;|</a>&nbsp;
         													 </c:if>
											</c:forEach>
											...
											<a
												href="main_ok?page=${endpage }&select=${select}&textfield1=${textfield1}&thirdyear=${thiryear}&gender=${gender}&addr=${addr}"><img
